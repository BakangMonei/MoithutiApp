        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            registerButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    {
                        Toast.makeText(com.research.schoolingapp.signUp.this,"Please Enter All Details",Toast.LENGTH_SHORT).show();
                    }
                    if(Password.length()<6 || rePassword.length() < 6){
                        Toast.makeText(com.research.schoolingapp.signUp.this,"Password Too Short !",Toast.LENGTH_SHORT).show();
                    }
                    if(Password == rePassword && rePassword == Password){
                        Toast.makeText(com.research.schoolingapp.signUp.this,"Passwords do not match",Toast.LENGTH_SHORT).show();
                    }
                    else {
        ...
        public void registerStudent(String registerEmail, String registerFirstName,
            ...
            mAuth.createUserWithEmailAndPassword(registerEmail,registerPassword).addOnSuccessListener(new OnSuccessListener<AuthResult>(){
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>(){
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Toast.makeText(com.research.schoolingapp.signUp.this,"Successfully Registered", Toast.LENGTH_LONG).show();
                                        Intent intent= new Intent(com.research.schoolingapp.signUp.this, MainActivity.class);
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(com.research.schoolingapp.signUp.this,e.getMessage().toString(),
